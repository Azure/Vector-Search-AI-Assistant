...
namespace VectorSearchAiAssistant.Service.Tests
{
    ...
    public class CosmosDbServiceTests
    {
        ...
        public async Task GetSessionMessagesAsync_ShouldReturnListOfMessagesForSession()
        {
            ...
            {
                new Message(sessionId, "User", 1536, "What kind of socks do you have available?"),
                new Message(sessionId, "Assistant", 26, "We have two types of socks available: Racing Socks and Mountain Bike Socks. Both are available in sizes L and M."),
            };
