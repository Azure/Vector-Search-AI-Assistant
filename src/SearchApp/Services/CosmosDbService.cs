...
namespace SearchApp.Services
{
    public class CustomerService
    {
        ...
        /// </remarks>
        public CustomerService(string connection, string databaseName, string collectionNames, string maxVectorSearchResults, OpenAiService openAiService, ILogger logger)
        {
