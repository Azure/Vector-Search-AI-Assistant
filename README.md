...
- [Official Version: Azure OpenAI Service + Azure Cosmos DB + Azure Cognitive Search + Azure Container Apps](https://github.com/Azure/Vector-Search-Ai-Assistant/tree/cognitive-search-vector)
